  ...
  const teamMembers = [
    {
      ...
      image: '/team-1.jpg',
      bio: 'With over 15 years of experience in community development, Grace leads our organization with a vision of sustainable transformation. Her strategic leadership ensures all initiatives align with our core mission.',
    },
    {
      name: 'James Mutebi',
      ...
      image: '/team-2.jpg',
      bio: 'James brings deep expertise in program management and community engagement. He oversees the execution of all initiatives, ensuring maximum impact and accountability across all communities we serve.',
    },
  ]
  ...
  const values = [
    {
      ...
      description: 'We place communities at the heart of all decisions, ensuring their voices shape our work.',
    },
    {
      title: 'Sustainability',
      description: 'We design programs that create lasting change and empower communities for long-term success.',
    },
    {
      title: 'Inclusivity',
      description: 'We ensure all marginalized groups have equal access to opportunities and services.',
    },
    {
      title: 'Accountability',
      description: 'We maintain transparent reporting and responsible use of all resources entrusted to us.',
    },
    {
      title: 'Integrity',
      description: 'We operate with honesty, respect, and commitment to our mission and beneficiaries.',
    },
    {
      title: 'Excellence',
      description: 'We strive for the highest quality in everything we do, continuously improving our impact.',
    },
  ]
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-muted-foreground mb-4 leading-relaxed">
                Founded in 2018, we are committed to improving people's lives while fostering sustainable development through evidence-based interventions, community engagement, and strategic partnerships.
              </p>
        ...
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            {teamMembers.map((member, index) => (
              <div
                key={index}
                className="bg-white rounded-xl overflow-hidden shadow-lg hover:shadow-xl transition border border-border"
              >
